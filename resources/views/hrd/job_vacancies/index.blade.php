...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('hrd.job_vacancies.create') }}" class="btn btn-primary"><i
                class="bi bi-plus-circle-fill me-2"></i>Tambah Lowongan Baru</a>
    </div>
                ...
                <table class="table-hover table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="btn btn-sm btn-outline-dark">{{ $vacancy->applications_count }}
                                    Pelamar</span>
                            </td>
                            <td class="text-center">
                                <!-- <a href="#" class="btn btn-sm btn-info" title="Lihat Pelamar"><i
                                        class="bi bi-people-fill"></i></a> -->
                                <a href="{{ route('hrd.job_vacancies.edit', $vacancy) }}" class="btn btn-sm btn-warning"
                                    title="Edit"><i class="bi bi-pencil-fill"></i></a>
                                <form action="{{ route('hrd.job_vacancies.destroy', $vacancy) }}" method="POST"
                                    class="d-inline"
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="py-4 text-center">Belum ada data lowongan pekerjaan.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
